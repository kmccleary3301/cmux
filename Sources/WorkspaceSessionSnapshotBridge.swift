...
extension Workspace {
    nonisolated static let remoteDaemonManifestInfoKey = WorkspaceRemoteSessionRuntimeSupport.remoteDaemonManifestInfoKey

    nonisolated static func remoteDaemonManifest(from infoDictionary: [String: Any]?) -> WorkspaceRemoteDaemonManifest? {
        WorkspaceRemoteSessionRuntimeSupport.remoteDaemonManifest(from: infoDictionary)
    }
    ...
    nonisolated static func remoteDaemonCachedBinaryURL(
        ...
        try WorkspaceRemoteSessionRuntimeSupport.remoteDaemonCachedBinaryURL(
            version: version,
            goOS: goOS,
            goArch: goArch,
